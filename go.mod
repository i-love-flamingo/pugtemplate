...
require (
	...
	flamingo.me/flamingo/v3 v3.0.0-alpha3
	...
	golang.org/x/build v0.0.0-20190214042318-34b995b40b0d // indirect
	...
	golang.org/x/tools v0.0.0-20190214043641-508f945e1a9b // indirect
